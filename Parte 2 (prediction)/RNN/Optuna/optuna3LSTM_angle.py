...
results_dir = "optuna_resultsLSTMBIEN_angle"
...
# ---------- CARGA Y PROCESADO ----------
DATA_PTH = r"C:/Users/adria/Downloads/Python-IMU/Adriana-Neuroengineering_lab/Archivos_red/suavizados"

data_path = DATA_PTH
csv_files = glob.glob(
    os.path.join(DATA_PTH, "*_subject_01_cond_ASS-PRE-EXT-*_run*_ecr_fcr_final_suavizado.csv")
)
...
class SeqLSTMModel(nn.Module):
    def __init__(self, input_dim=1, hidden_dim=64, output_dim=1, num_layers=2, dropout_prob=0.2):
